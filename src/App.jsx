...
const bankSoal = [
  // 1. LANDASAN HUKUM
  { id:1, topik:"Landasan Hukum", soal:"Landasan konstitusional berdirinya koperasi di Indonesia adalah...", opsi:["A. UUD 1945 Pasal 33 ayat (1)","B. UU No. 25 Tahun 1992","C. Pancasila sila ke-5","D. Inpres No. 9 Tahun 2025"], jawaban:"A", pembahasan:"UUD 1945 Pasal 33 ayat (1): 'Perekonomian disusun sebagai usaha bersama berdasar atas asas kekeluargaan.' Ini adalah landasan KONSTITUSIONAL koperasi. Pancasila adalah landasan idiil." },
  { id:2, topik:"Landasan Hukum", soal:"Undang-Undang Perkoperasian yang berlaku di Indonesia saat ini adalah...", opsi:["A. UU No. 17 Tahun 2012","B. UU No. 25 Tahun 1992","C. UU No. 13 Tahun 2003","D. UU No. 20 Tahun 2008"], jawaban:"B", pembahasan:"UU No. 25 Tahun 1992 adalah landasan hukum operasional koperasi. UU No. 17 Tahun 2012 pernah ada namun dibatalkan oleh Mahkamah Konstitusi." },
  ...
  { id:4, topik:"Landasan Hukum", soal:"Pasal berapa dalam UUD 1945 yang menyebutkan perekonomian berdasar asas kekeluargaan?", opsi:["A. Pasal 27 ayat (2)","B. Pasal 34 ayat (1)","C. Pasal 28 ayat (1)","D. Pasal 33 ayat (1)"], jawaban:"D", pembahasan:"Pasal 33 ayat (1) UUD 1945 berbunyi 'Perekonomian disusun sebagai usaha bersama berdasar atas asas kekeluargaan.' Inilah fondasi konstitusional koperasi Indonesia." },
  { id:5, topik:"Landasan Hukum", soal:"Berdasarkan UU No. 25 Tahun 1992, koperasi didefinisikan sebagai...", opsi:["A. Badan usaha beranggotakan orang/badan hukum koperasi yang melandaskan kegiatan berdasarkan prinsip koperasi sebagai gerakan ekonomi rakyat","B. Perusahaan milik pemerintah yang bertujuan mencari laba","C. Lembaga sosial non-profit milik desa","D. Badan usaha swasta yang beroperasi di perdesaan"], jawaban:"A", pembahasan:"Definisi lengkap koperasi menurut UU 25/1992 menekankan: badan usaha, beranggotakan orang/badan hukum koperasi, berprinsip koperasi, gerakan ekonomi rakyat, asas kekeluargaan." },
  { id:6, topik:"Landasan Hukum", soal:"Dokumen hukum yang menjadi dasar tata kelola internal koperasi disebut...", opsi:["A. RKAT","B. Anggaran Dasar dan Anggaran Rumah Tangga (AD/ART)","C. Laporan RAT","D. Surat Keputusan Kepala Desa"], jawaban:"B", pembahasan:"AD/ART adalah dokumen hukum utama yang mengatur tata kelola, hak, kewajiban, dan mekanisme operasional koperasi. Wajib dimiliki dan disahkan Rapat Anggota." },
  // 2. REGULASI KDKMP
  ...
  { id:8, topik:"Regulasi KDKMP", soal:"Instruksi Presiden yang menjadi dasar hukum percepatan pembentukan KDKMP adalah...", opsi:["A. Inpres No. 14 Tahun 2025","B. Inpres No. 17 Tahun 2025","C. Inpres No. 7 Tahun 2025","D. Inpres No. 9 Tahun 2025"], jawaban:"D", pembahasan:"Inpres No. 9 Tahun 2025 tentang Percepatan Pembentukan Koperasi Desa/Kelurahan Merah Putih adalah dasar hukum utama dan program prioritas Presiden." },
  { id:9, topik:"Regulasi KDKMP", soal:"Inpres No. 17 Tahun 2025 mengatur tentang...", opsi:["A. Percepatan Pembangunan Fisik Gerai dan Pergudangan KDKMP","B. Percepatan pembentukan Koperasi Desa Merah Putih","C. Swasembada pangan nasional","D. Rekrutmen manajer koperasi"], jawaban:"A", pembahasan:"Inpres No. 17 Tahun 2025 mengatur percepatan pembangunan fisik gerai dan pergudangan KDKMP sebagai infrastruktur pendukung operasional koperasi desa." },
  ...
  { id:11, topik:"Regulasi KDKMP", soal:"Perbedaan mendasar KDKMP dengan BUMDes adalah...", opsi:["A. KDKMP lebih kecil dari BUMDes","B. BUMDes tidak boleh mencari keuntungan","C. KDKMP berasaskan kekeluargaan dan dimiliki anggota, BUMDes adalah badan usaha milik pemerintah desa","D. Keduanya sama saja"], jawaban:"C", pembahasan:"KDKMP berbasis koperasi (dimiliki anggota, asas kekeluargaan). BUMDes adalah badan usaha milik pemerintah desa. Berbeda secara hukum, kepemilikan, dan struktur pengambilan keputusan." },
  { id:12, topik:"Regulasi KDKMP", soal:"Format penamaan resmi Koperasi Desa Merah Putih adalah...", opsi:["A. Nama kepala desa + Koperasi","B. Nama BUMDes yang sudah ada","C. Nama bebas sesuai kesepakatan anggota","D. 'Koperasi Desa/Kelurahan Merah Putih' + nama wilayah"], jawaban:"D", pembahasan:"Pedoman PHTC mewajibkan format: 'Koperasi' + 'Desa/Kelurahan Merah Putih' + nama desa/kelurahan untuk standarisasi identitas nasional program." },
  // 3. PRINSIP KOPERASI
  { id:13, topik:"Prinsip Koperasi", soal:"Prinsip pengambilan keputusan yang membedakan koperasi dari perusahaan biasa adalah...", opsi:["A. Hak suara sama setiap anggota (one member one vote)","B. Berdasarkan jumlah modal yang disetor","C. Hanya pengurus yang berhak memutuskan","D. Berdasarkan jabatan dalam kepengurusan"], jawaban:"A", pembahasan:"Prinsip 'one member one vote' adalah ciri khas koperasi. Setiap anggota punya hak suara sama terlepas dari besar kecilnya modal — berbeda dari PT yang berdasarkan jumlah saham." },
  { id:14, topik:"Prinsip Koperasi", soal:"Manakah yang BUKAN termasuk 7 prinsip koperasi internasional (ICA)?", opsi:["A. Keanggotaan sukarela dan terbuka","B. Keuntungan dibagi berdasarkan jumlah saham","C. Pengendalian oleh anggota secara demokratis","D. Kepedulian terhadap komunitas"], jawaban:"B", pembahasan:"Pembagian keuntungan berdasarkan saham adalah prinsip perusahaan, bukan koperasi. Koperasi membagi SHU berdasarkan partisipasi transaksi anggota." },
  { id:15, topik:"Prinsip Koperasi", soal:"Tujuan koperasi berdasarkan UU No. 25 Tahun 1992 Pasal 3 adalah...", opsi:["A. Memaksimalkan keuntungan untuk investor","B. Menjadi perusahaan terbesar di wilayah desa","C. Memajukan kesejahteraan anggota pada khususnya dan masyarakat pada umumnya","D. Mengalahkan minimarket swasta"], jawaban:"C", pembahasan:"Pasal 3 UU 25/1992: tujuan koperasi adalah memajukan kesejahteraan anggota pada khususnya dan masyarakat pada umumnya, serta ikut membangun tatanan perekonomian nasional." },
  { id:16, topik:"Prinsip Koperasi", soal:"Koperasi desa A dan B bergabung membeli sembako agar lebih murah. Prinsip koperasi apa yang diterapkan?", opsi:["A. Kemandirian","B. Otonomi koperasi","C. Pendidikan anggota","D. Kerja sama antar koperasi"], jawaban:"D", pembahasan:"Kerja sama antar koperasi (prinsip ke-6 ICA) mendorong koperasi bersinergi demi memperkuat posisi tawar dan efisiensi operasional bersama." },
  { id:17, topik:"Prinsip Koperasi", soal:"Koperasi menyisihkan SHU untuk membangun fasilitas desa. Ini mencerminkan prinsip...", opsi:["A. Kepedulian terhadap komunitas","B. Pengendalian demokratis","C. Otonomi dan kemandirian","D. Kerja sama antar koperasi"], jawaban:"A", pembahasan:"Kepedulian terhadap komunitas (prinsip ke-7 ICA) mendorong koperasi berkontribusi pada pembangunan berkelanjutan di lingkungan sekitarnya." },
  { id:18, topik:"Prinsip Koperasi", soal:"Anggota yang ingin keluar dari koperasi, berdasarkan prinsip koperasi, berhak...", opsi:["A. Tidak boleh keluar selama punya simpanan","B. Keluar sesuai ketentuan AD/ART tanpa paksaan","C. Keluar dengan membayar denda besar","D. Keluar hanya setelah persetujuan pengurus"], jawaban:"B", pembahasan:"Prinsip keanggotaan sukarela: anggota bebas masuk dan keluar. Mekanismenya diatur AD/ART, namun tidak boleh ada pemaksaan untuk tetap bergabung." },
  ...
  { id:20, topik:"Struktur Organisasi", soal:"Tugas utama Pengawas koperasi adalah...", opsi:["A. Mengelola operasional harian","B. Menentukan besaran SHU","C. Mewakili koperasi dalam perjanjian bisnis","D. Mengawasi pelaksanaan kebijakan dan pengelolaan oleh Pengurus"], jawaban:"D", pembahasan:"Pengawas bertugas mengawasi dan memeriksa pelaksanaan kebijakan serta pengelolaan koperasi oleh Pengurus, memastikan sesuai prinsip dan AD/ART." },
  { id:21, topik:"Struktur Organisasi", soal:"RKAT (Rencana Kerja dan Anggaran Tahunan) harus disahkan oleh...", opsi:["A. Rapat Anggota","B. Manajer KDKMP","C. Pengawas Koperasi","D. Dinas Koperasi Kabupaten"], jawaban:"A", pembahasan:"RKAT adalah dokumen perencanaan strategis tahunan yang WAJIB disahkan Rapat Anggota sebagai pemegang kekuasaan tertinggi sebelum dijalankan Pengurus." },
  { id:22, topik:"Struktur Organisasi", soal:"Masa jabatan maksimal Pengurus Koperasi dalam satu periode adalah...", opsi:["A. 2 tahun","B. 5 tahun","C. 3 tahun","D. Seumur hidup"], jawaban:"B", pembahasan:"Berdasarkan UU No. 25/1992, masa jabatan pengurus paling lama 5 tahun dan dapat dipilih kembali sesuai ketentuan AD/ART koperasi." },
  ...
  { id:24, topik:"Struktur Organisasi", soal:"Hak anggota dalam RAT yang WAJIB dipenuhi adalah...", opsi:["A. Mendapat gaji bulanan dari koperasi","B. Menjadi direktur unit usaha tanpa seleksi","C. Mendapat pinjaman tanpa bunga seumur hidup","D. Memilih dan dipilih pengurus/pengawas serta mendapat informasi laporan keuangan"], jawaban:"D", pembahasan:"Hak anggota dalam RAT: memilih dan dipilih menjadi pengurus/pengawas, menyampaikan pendapat, dan mendapat informasi penuh tentang perkembangan keuangan koperasi." },
  // 5. PERMODALAN
  { id:25, topik:"Permodalan", soal:"Simpanan yang dibayar SATU KALI saat pertama masuk dan tidak bisa diambil selama aktif adalah...", opsi:["A. Simpanan Pokok","B. Simpanan Wajib","C. Simpanan Sukarela","D. Dana Cadangan"], jawaban:"A", pembahasan:"Simpanan Pokok: dibayar satu kali saat daftar, nilainya sama untuk semua anggota, tidak dapat diambil selama masih aktif menjadi anggota." },
  ...
  { id:28, topik:"Permodalan", soal:"Dana yang disisihkan dari SHU untuk memperkuat modal dan tidak dibagikan disebut...", opsi:["A. Simpanan Wajib","B. Jasa Modal","C. Dana Sosial","D. Dana Cadangan"], jawaban:"D", pembahasan:"Dana Cadangan disisihkan dari SHU untuk memperkuat posisi keuangan dan menghadapi risiko koperasi di masa mendatang. Tidak dibagikan kepada anggota." },
  { id:29, topik:"Permodalan", soal:"Urutan sumber modal internal yang tepat sebelum mencari pinjaman luar adalah...", opsi:["A. Dana Cadangan → penambahan Simpanan Wajib → pinjaman eksternal","B. Langsung pinjam ke bank","C. Jual aset tetap terlebih dahulu","D. Minta suntikan dana pemerintah"], jawaban:"A", pembahasan:"Prinsip kemandirian koperasi: utamakan modal internal (Dana Cadangan, Simpanan Wajib) sebelum mencari modal eksternal dari bank atau lembaga keuangan." },
  ...
  { id:32, topik:"SHU", soal:"Dasar pembagian SHU yang paling sesuai prinsip koperasi adalah...", opsi:["A. Jumlah simpanan pokok","B. Lamanya menjadi anggota","C. Jabatan dalam kepengurusan","D. Partisipasi/jasa usaha anggota dalam kegiatan koperasi"], jawaban:"D", pembahasan:"Prinsip koperasi: SHU dibagi adil berdasarkan partisipasi/jasa usaha (volume transaksi) anggota. Anggota aktif bertransaksi mendapat lebih banyak." },
  { id:33, topik:"SHU", soal:"Bagian SHU yang diterima anggota berdasarkan besarnya simpanan disebut...", opsi:["A. Jasa Modal","B. Jasa Usaha","C. Dana Pendidikan","D. Dana Sosial"], jawaban:"A", pembahasan:"Jasa Modal adalah komponen SHU yang diberikan kepada anggota berdasarkan besarnya simpanan yang disetor, sebagai apresiasi kontribusi modal anggota." },
  ...
  { id:36, topik:"SHU", soal:"Ada perbedaan pendapat antara pengurus (mau perbesar Dana Cadangan) dan anggota (mau SHU lebih besar). Manajer harus...", opsi:["A. Ikuti pengurus karena berkewenangan","B. Ikuti keinginan anggota agar tidak konflik","C. Tunda pembagian tanpa batas waktu","D. Mengacu pada AD/ART dan keputusan RAT"], jawaban:"D", pembahasan:"Pembagian SHU harus mengacu pada AD/ART dan keputusan RAT. Dokumen ini mengikat semua pihak dan tidak boleh diubah sepihak oleh pengurus maupun manajer." },
  // 7. LAPORAN KEUANGAN
  { id:37, topik:"Laporan Keuangan", soal:"Laporan yang menggambarkan posisi aset, kewajiban, dan modal pada suatu tanggal tertentu adalah...", opsi:["A. Neraca (Laporan Posisi Keuangan)","B. Laporan Arus Kas","C. Laporan SHU","D. Laporan Perubahan Modal"], jawaban:"A", pembahasan:"Neraca menggambarkan kondisi finansial koperasi pada titik waktu tertentu. Rumus: Aset = Kewajiban + Modal. Wajib dilaporkan dalam RAT." },
  ...
  { id:40, topik:"Laporan Keuangan", soal:"Manajer menemukan selisih antara kas fisik dan catatan. Langkah pertama yang benar adalah...", opsi:["A. Langsung pecat kasir","B. Tutupi dengan dana pribadi","C. Biarkan saja jika selisihnya kecil","D. Telusuri semua transaksi dan bukti pembayaran"], jawaban:"D", pembahasan:"Prosedur audit yang benar: telusuri seluruh bukti transaksi untuk menemukan sumber selisih SEBELUM mengambil tindakan. Transparansi dan kehati-hatian adalah kunci." },
  { id:41, topik:"Laporan Keuangan", soal:"Yang termasuk ASET LANCAR koperasi adalah...", opsi:["A. Kas, piutang, dan persediaan barang","B. Tanah dan bangunan kantor","C. Kendaraan operasional","D. Mesin dan peralatan"], jawaban:"A", pembahasan:"Aset lancar = dapat dicairkan <1 tahun: kas, piutang anggota, persediaan barang. Aset tetap = jangka panjang: tanah, gedung, kendaraan, mesin." },
  ...
  // 8. FUNGSI MANAJEMEN
  { id:43, topik:"Fungsi Manajemen", soal:"Manajer menetapkan target penjualan dan menyusun anggaran tahun depan. Fungsi manajemen yang dijalankan adalah...", opsi:["A. Organizing","B. Actuating","C. Planning","D. Controlling"], jawaban:"C", pembahasan:"Planning = menetapkan tujuan, target, strategi, dan anggaran. Ini adalah fungsi PERTAMA dan fondasi dari seluruh siklus manajemen." },
  { id:44, topik:"Fungsi Manajemen", soal:"Manajer membagi tugas: 2 orang keuangan, 3 gudang, 2 pelayanan. Fungsi yang dijalankan adalah...", opsi:["A. Planning","B. Actuating","C. Controlling","D. Organizing"], jawaban:"D", pembahasan:"Organizing = membagi tugas, menetapkan struktur, mendistribusikan tanggung jawab kepada anggota tim untuk mencapai tujuan." },
  { id:45, topik:"Fungsi Manajemen", soal:"Manajer menggerakkan tim, memberi motivasi, dan memastikan semua bekerja sesuai target. Fungsi yang dijalankan adalah...", opsi:["A. Actuating","B. Planning","C. Organizing","D. Controlling"], jawaban:"A", pembahasan:"Actuating = memotivasi, mengarahkan, dan menggerakkan tim agar bekerja optimal menuju tujuan yang telah ditetapkan." },
  { id:46, topik:"Fungsi Manajemen", soal:"Manajer membandingkan realisasi vs target, menemukan gap 40%, lalu melakukan koreksi. Fungsi yang dijalankan adalah...", opsi:["A. Planning","B. Controlling","C. Organizing","D. Actuating"], jawaban:"B", pembahasan:"Controlling = mengukur realisasi vs rencana, menganalisis penyimpangan, dan mengambil tindakan korektif agar tujuan tetap tercapai." },
  ...
  { id:48, topik:"Fungsi Manajemen", soal:"Urutan fungsi manajemen POAC yang BENAR adalah...", opsi:["A. Organizing → Planning → Controlling → Actuating","B. Actuating → Planning → Organizing → Controlling","C. Controlling → Organizing → Planning → Actuating","D. Planning → Organizing → Actuating → Controlling"], jawaban:"D", pembahasan:"Siklus manajemen: Planning (rencanakan) → Organizing (atur struktur) → Actuating (gerakkan tim) → Controlling (awasi & evaluasi). Siklus ini terus berulang." },
  // 9. KEPEMIMPINAN & TIM
  { id:49, topik:"Kepemimpinan & Tim", soal:"Tim sering datang tepat waktu tapi produktivitas rendah. Pendekatan manajemen terbaik adalah...", opsi:["A. Tetapkan target kerja yang jelas dan terukur (task-based)","B. Perketat aturan absensi","C. Kurangi jumlah anggota tim","D. Serahkan ke pengurus"], jawaban:"A", pembahasan:"Task-based (berbasis hasil/target) lebih efektif dari hour-based (berbasis jam hadir). Target jelas mendorong produktivitas dan tanggung jawab individu." },
  { id:50, topik:"Kepemimpinan & Tim", soal:"Ada konflik antara dua anggota tim. Gaya kepemimpinan terbaik manajer adalah...", opsi:["A. Biarkan mereka selesaikan sendiri","B. Fasilitasi mediasi dan komunikasi terbuka untuk solusi win-win","C. Langsung pecat salah satu","D. Laporkan ke pengurus untuk RAT"], jawaban:"B", pembahasan:"Kepemimpinan situasional dalam koperasi mengutamakan musyawarah. Manajer berperan sebagai fasilitator mediasi untuk mempertahankan keutuhan dan produktivitas tim." },
  { id:51, topik:"Kepemimpinan & Tim", soal:"Manajer baru menghadapi tim yang belum berpengalaman. Gaya kepemimpinan paling tepat adalah...", opsi:["A. Delegatif — serahkan semua ke tim","B. Laissez-faire — biarkan tim mandiri","C. Direktif — instruksi jelas, bimbing langsung, awasi ketat","D. Otoriter — hukum yang salah tanpa penjelasan"], jawaban:"C", pembahasan:"Untuk tim baru yang belum berpengalaman, gaya direktif paling efektif. Instruksi jelas + pelatihan + pengawasan ketat sampai tim cukup kompeten." },
  { id:52, topik:"Kepemimpinan & Tim", soal:"Unit simpan pinjam kinerja turun karena tim tidak paham prosedur analisis kredit. Solusi terbaik adalah...", opsi:["A. Tutup unit simpan pinjam","B. Ganti seluruh anggota tim","C. Laporkan ke pengawas sebagai masalah struktural","D. Berikan pelatihan teknis dan pendampingan intensif"], jawaban:"D", pembahasan:"Pelatihan dan pengembangan kompetensi adalah solusi tepat ketika masalah kinerja bersumber dari kurangnya pengetahuan. Investasi SDM lebih efektif dari pergantian personel." },
  { id:53, topik:"Kepemimpinan & Tim", soal:"Anggota tim senior menolak digitalisasi sistem keuangan. Pendekatan terbaik adalah...", opsi:["A. Libatkan dalam perencanaan dan berikan pelatihan bertahap","B. Langsung berhentikan yang menolak","C. Tunda digitalisasi selamanya","D. Paksa tanpa diskusi"], jawaban:"A", pembahasan:"Change management yang efektif: libatkan pemangku kepentingan dalam perencanaan dan sediakan pelatihan bertahap. Ini membangun rasa kepemilikan dan mengurangi resistensi." },
  { id:54, topik:"Kepemimpinan & Tim", soal:"Prinsip kepemimpinan efektif dalam konteks koperasi adalah...", opsi:["A. Pemimpin selalu lebih tahu dari anggota","B. Servant leadership — melayani anggota dan memberdayakan tim","C. Kepentingan pemimpin di atas kepentingan anggota","D. Keputusan dibuat sepihak tanpa melibatkan tim"], jawaban:"B", pembahasan:"Servant leadership sangat relevan untuk koperasi berasas kekeluargaan. Manajer efektif memberdayakan tim dan mengutamakan kepentingan anggota di atas kepentingan pribadi." },
  // 10. MODEL BISNIS
  { id:55, topik:"Model Bisnis", soal:"Sebelum membuka unit usaha baru, analisis PERTAMA yang harus dilakukan manajer adalah...", opsi:["A. Langsung beli peralatan dan sewa gedung","B. Minta modal dari pemerintah desa dahulu","C. Analisis kebutuhan anggota, potensi pasar, dan kelayakan bisnis","D. Tiru model bisnis koperasi lain persis sama"], jawaban:"C", pembahasan:"Studi kelayakan bisnis yang komprehensif (analisis kebutuhan, riset pasar, kelayakan finansial) adalah langkah pertama wajib sebelum membuka unit usaha baru." },
  { id:56, topik:"Model Bisnis", soal:"Rantai pasok ideal untuk unit usaha sembako KDKMP adalah...", opsi:["A. Beli dari tengkulak yang menentukan harga","B. Impor semua dari luar daerah","C. Tunggu anggota bawa barang sendiri","D. Petani/produsen lokal → gudang koperasi → anggota/konsumen"], jawaban:"D", pembahasan:"Rantai pasok pendek (petani lokal → koperasi → konsumen) memotong tengkulak: petani harga lebih baik, konsumen lebih murah, ekonomi lokal menguat." },
  { id:57, topik:"Model Bisnis", soal:"Unit simpan pinjam mengalami peningkatan kredit macet. Langkah strategis terbaik adalah...", opsi:["A. Restrukturisasi kredit macet + perketat analisis pinjaman baru","B. Hentikan seluruh pemberian kredit baru","C. Hapus semua kredit macet dari pembukuan","D. Tutup unit simpan pinjam permanen"], jawaban:"A", pembahasan:"Restrukturisasi (penjadwalan ulang, keringanan) untuk kredit macet + analisis kelayakan lebih ketat untuk pinjaman baru adalah standar manajemen risiko kredit." },
  ...
  { id:59, topik:"Model Bisnis", soal:"KDKMP punya cold storage. Strategi penggunaan terbaik untuk petani anggota adalah...", opsi:["A. Sewakan ke pengusaha luar","B. Hanya dipakai saat bencana","C. Simpan panen anggota agar bisa dijual saat harga pasar tinggi","D. Jual karena biaya listrik mahal"], jawaban:"C", pembahasan:"Cold storage memungkinkan petani simpan panen lebih lama, tidak terpaksa jual murah saat panen raya. Ini strategi penguatan posisi tawar petani yang efektif." },
  { id:60, topik:"Model Bisnis", soal:"Unit apotek KDKMP wajib memenuhi persyaratan utama berupa...", opsi:["A. Persetujuan tengkulak dan pengurus saja","B. Modal minimal Rp5 miliar","C. Rekomendasi kepala desa saja sudah cukup","D. Tenaga apoteker berlisensi (SIPA) dan izin dari dinas kesehatan"], jawaban:"D", pembahasan:"Unit apotek wajib: apoteker berlisensi (Surat Izin Praktik Apoteker/SIPA) + izin operasional dari dinas kesehatan. Tanpa keduanya, apotek tidak legal beroperasi." },
  // 11. PELAYANAN ANGGOTA
  { id:61, topik:"Pelayanan Anggota", soal:"Standar pelayanan prima dalam koperasi yang paling penting adalah...", opsi:["A. Cepat, ramah, transparan, dan sama untuk semua anggota","B. Layani anggota bersimpanan besar lebih cepat","C. Prioritaskan anggota yang kenal pengurus","D. Layani hanya anggota aktif pembayar simpanan"], jawaban:"A", pembahasan:"Prinsip koperasi mengharuskan pelayanan adil, non-diskriminatif, dan berkualitas untuk SEMUA anggota. Transparansi membangun kepercayaan dan loyalitas jangka panjang." },
  ...
  { id:64, topik:"Pelayanan Anggota", soal:"Langkah strategis PALING efektif memperkuat kelembagaan KDKMP adalah...", opsi:["A. Bangun kantor yang megah","B. Perbanyak unit usaha tanpa pertimbangkan kapasitas","C. Ganti seluruh pengurus setiap tahun","D. Bangun kepercayaan melalui transparansi laporan keuangan dan peningkatan layanan berkelanjutan"], jawaban:"D", pembahasan:"Kelembagaan kuat dibangun di atas kepercayaan anggota. Transparansi keuangan, akuntabilitas, dan peningkatan layanan berkelanjutan adalah fondasinya." },
  { id:65, topik:"Pelayanan Anggota", soal:"Indikator koperasi sehat dari aspek pelayanan anggota adalah...", opsi:["A. Tingginya kepuasan dan partisipasi aktif anggota","B. Pengurus bergaji tinggi","C. Kantor koperasi mewah","D. Banyak unit usaha meski merugi"], jawaban:"A", pembahasan:"Koperasi sehat dari aspek pelayanan: anggota aktif, puas dengan layanan, dan merasakan manfaat nyata. Ini cerminan keberhasilan misi koperasi." },
  { id:66, topik:"Pelayanan Anggota", soal:"Anggota mengeluh pencairan pinjaman terlalu lambat. Respon terbaik manajer adalah...", opsi:["A. Abaikan karena prosedur sudah benar","B. Analisis proses dan sederhanakan prosedur tanpa korbankan kehati-hatian","C. Salahkan anggota karena dokumen tidak lengkap","D. Hapus prosedur verifikasi agar lebih cepat"], jawaban:"B", pembahasan:"Keluhan adalah umpan balik berharga. Analisis bottleneck proses → cari efisiensi → tetap jaga kehati-hatian dalam pemberian pinjaman. Jangan ekstrem ke kiri atau kanan." },
  // 12. PENGAWASAN INTERNAL
  { id:67, topik:"Pengawasan Internal", soal:"Tujuan utama sistem pengawasan internal (audit internal) koperasi adalah...", opsi:["A. Mencari kesalahan karyawan untuk dipecat","B. Membuat laporan untuk pemerintah saja","C. Memastikan kegiatan sesuai aturan, mencegah penyimpangan, dan meningkatkan efisiensi","D. Mengawasi anggota agar tidak keluar"], jawaban:"C", pembahasan:"Pengawasan internal bertujuan: kepatuhan terhadap aturan, pencegahan/deteksi dini penyimpangan, dan peningkatan efisiensi operasional koperasi." },
  { id:68, topik:"Pengawasan Internal", soal:"Manajer menemukan indikasi penggelapan dana oleh staf. Langkah yang BENAR adalah...", opsi:["A. Selesaikan kekeluargaan tanpa dokumentasi","B. Langsung pecat tanpa investigasi","C. Minta staf ganti sendiri dan rahasiakan","D. Investigasi menyeluruh, dokumentasikan bukti, laporkan ke Pengurus dan Pengawas"], jawaban:"D", pembahasan:"Prosedur penanganan penyimpangan: investigasi terstruktur → dokumentasi bukti → laporan ke Pengurus dan Pengawas. Transparansi dan akuntabilitas tidak boleh dikompromikan." },
  { id:69, topik:"Pengawasan Internal", soal:"Mekanisme pengawasan terbaik untuk mencegah penyimpangan di unit usaha sembako adalah...", opsi:["A. Pemisahan fungsi + stock opname berkala + rekonsiliasi kas harian","B. Andalkan kejujuran karyawan saja","C. Pasang CCTV di semua sudut saja","D. Serahkan pengawasan ke kepala desa"], jawaban:"A", pembahasan:"Internal control yang kuat: segregation of duties (pisah fungsi pencatat vs pemegang uang), stock opname berkala, rekonsiliasi harian. Ini standar pengendalian internal efektif." },
  { id:70, topik:"Pengawasan Internal", soal:"Indikator koperasi TIDAK sehat dari aspek keuangan adalah...", opsi:["A. Rasio likuiditas di atas 100%","B. Kredit macet (NPL) lebih dari 5% dari total pinjaman","C. SHU terus meningkat setiap tahun","D. Dana cadangan terus bertumbuh"], jawaban:"B", pembahasan:"NPL >5% mengindikasikan koperasi tidak sehat: lemahnya analisis kredit, pengawasan, dan penagihan piutang. Perlu tindakan korektif segera." },
  ...
  { id:72, topik:"Pengawasan Internal", soal:"Mekanisme pengawasan eksternal koperasi yang efektif dilakukan melalui...", opsi:["A. Kepala desa ambil alih pengelolaan langsung","B. Pemerintah desa tidak perlu mengawasi","C. Hanya inspeksi mendadak tanpa pemberitahuan","D. Laporan berkala + audit independen + musyawarah desa untuk evaluasi"], jawaban:"D", pembahasan:"Pengawasan eksternal efektif: laporan berkala ke pemerintah desa, audit independen pihak ketiga, dan musyawarah desa sebagai forum evaluasi program." },
  // 13. TANGGUNG JAWAB HUKUM
  { id:73, topik:"Tanggung Jawab Hukum", soal:"Koperasi dilikuidasi, aset tidak cukup menutup hutang. Tanggung jawab anggota (sistem terbatas) adalah...", opsi:["A. Anggota bertanggung jawab sebatas simpanan pokok dan wajib yang disetor","B. Wajib jual aset pribadi","C. Pengurus menanggung seluruh hutang","D. Pemerintah desa wajib menutup kekurangan"], jawaban:"A", pembahasan:"Dalam sistem tanggung jawab terbatas, anggota hanya bertanggung jawab sebatas modal yang telah disetor (simpanan pokok + wajib). Tidak menyentuh harta pribadi anggota." },
  ...
  { id:75, topik:"Tanggung Jawab Hukum", soal:"Manajer menandatangani kontrak Rp500 juta tanpa persetujuan pengurus. Konsekuensinya adalah...", opsi:["A. Kontrak sah karena manajer pimpinan operasional","B. Seluruh anggota bertanggung jawab","C. Kontrak dapat dibatalkan karena manajer melampaui kewenangannya","D. Pengawas yang menanggung risiko"], jawaban:"C", pembahasan:"Manajer hanya berwenang dalam batas yang ditetapkan Pengurus dan AD/ART. Tindakan ultra vires (melebihi kewenangan) dapat dibatalkan secara hukum." },
  { id:76, topik:"Tanggung Jawab Hukum", soal:"Forum penyelesaian sengketa PERTAMA yang harus ditempuh dalam koperasi adalah...", opsi:["A. Langsung ke Pengadilan Negeri","B. Lapor ke Polisi","C. Arbitrase internasional","D. Musyawarah mufakat dalam Rapat Anggota"], jawaban:"D", pembahasan:"Prinsip koperasi mengutamakan musyawarah mufakat. Selesaikan internal dulu melalui Rapat Anggota sebelum dibawa ke jalur hukum formal." },
  { id:77, topik:"Tanggung Jawab Hukum", soal:"Koperasi yang tidak menyelenggarakan RAT selama 2 tahun berturut-turut dapat...", opsi:["A. Dibekukan atau dibubarkan oleh pejabat berwenang","B. Dikenai denda ringan saja","C. Pengurusnya dipenjara otomatis","D. Seluruh anggota didenda"], jawaban:"A", pembahasan:"Berdasarkan UU No. 25/1992, koperasi yang tidak memenuhi kewajiban hukum seperti penyelenggaraan RAT dapat dibekukan atau dibubarkan oleh pejabat yang berwenang." },
  ...
  { id:79, topik:"Strategi Ekonomi Desa", soal:"Tujuan UTAMA unit usaha sembako KDKMP adalah...", opsi:["A. Kalahkan minimarket swasta","B. Kumpulkan keuntungan sebesar-besarnya untuk pengurus","C. Percepat distribusi pangan dan stabilkan harga kebutuhan pokok masyarakat desa","D. Jadi agen tunggal pemerintah untuk pangan"], jawaban:"C", pembahasan:"Unit sembako KDKMP: jamin ketersediaan dan stabilitas harga pokok, potong rantai distribusi panjang, berdayakan ekonomi masyarakat desa. Bukan semata profit." },
  { id:80, topik:"Strategi Ekonomi Desa", soal:"Petani selalu jual panen murah ke tengkulak. Inovasi bisnis KDKMP terbaik adalah...", opsi:["A. Beri pinjaman ke tengkulak agar beli lebih banyak","B. Bangun kantor megah","C. Sarankan petani ganti komoditas","D. Buka unit pembelian hasil bumi dengan harga wajar + cold storage"], jawaban:"D", pembahasan:"Unit pembelian hasil bumi + cold storage memotong rantai tengkulak. Petani dapat harga adil, koperasi mendapat margin, konsumen mendapat harga stabil. Solusi terbaik." },
  { id:81, topik:"Strategi Ekonomi Desa", soal:"Strategi KDKMP paling memberdayakan untuk nelayan anggota adalah...", opsi:["A. Buka unit pengolahan dan pemasaran ikan langsung ke konsumen","B. Beli tangkapan murah untuk dijual lebih mahal","C. Hanya sewakan kapal saja","D. Hanya sediakan bahan bakar kapal"], jawaban:"A", pembahasan:"Pengolahan + pemasaran langsung meningkatkan nilai tambah, memangkas tengkulak, dan meningkatkan pendapatan nelayan anggota secara signifikan." },
  { id:82, topik:"Strategi Ekonomi Desa", soal:"Program KDKMP mendukung ketahanan pangan desa melalui cara berikut, KECUALI...", opsi:["A. Memastikan ketersediaan stok pangan di desa","B. Memonopoli harga pangan untuk keuntungan maksimal koperasi","C. Membangun jaringan distribusi efisien","D. Memberdayakan petani lokal sebagai pemasok utama"], jawaban:"B", pembahasan:"Memonopoli harga untuk keuntungan sendiri BERTENTANGAN dengan prinsip koperasi yang berorientasi kesejahteraan anggota dan masyarakat. KDKMP harus pastikan harga yang adil." },
  ...
  { id:84, topik:"Strategi Ekonomi Desa", soal:"Strategi jangka panjang terbaik KDKMP untuk ketahanan ekonomi desa adalah...", opsi:["A. Timbun stok pangan sebanyak mungkin","B. Bergantung sepenuhnya pada subsidi pemerintah","C. Tutup semua unit usaha dan simpan modal di bank","D. Bangun ekosistem produksi lokal terintegrasi: petani → koperasi → konsumen, didukung cold storage dan distribusi efisien"], jawaban:"D", pembahasan:"Ketahanan ekonomi jangka panjang dibangun melalui ekosistem terintegrasi: penguatan produksi lokal, efisiensi rantai pasok, dan infrastruktur memadai. Bukan ketergantungan subsidi." },
];
